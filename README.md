...
- Auto-merge se aplica a updates `patch/minor` de Dependabot (cualquier ecosistema) via `.github/workflows/dependabot-auto-merge.yml`; cambios `major` quedan manuales para control de riesgo.
